...
HD_PWD='C:/Users/User/Desktop/lab2/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log two_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source two_counter.tcl
